...
!    ksurf=46;    call write_cdf_2D_sigma(ksurf,counter_2d,n)    ! at 117 m depth
 ...
 ! sigma=257.d-1;  call write_cdf_2D_isopycnal(sigma,counter_2d,n) ! writes the solution on the sigma isopycnal
 ! sigma=258.d-1;  call write_cdf_2D_isopycnal(sigma,counter_2d,n) ! writes the solution on the sigma isopycnal
 ! sigma=259.d-1;  call write_cdf_2D_isopycnal(sigma,counter_2d,n) ! writes the solution on the sigma isopycnal
 ! sigma=26.d0;  call write_cdf_2D_isopycnal(sigma,counter_2d,n) ! writes the solution on the sigma isopycnal
 ! sigma=261.d-1;  call write_cdf_2D_isopycnal(sigma,counter_2d,n) ! writes the solution on the sigma isopycnal
